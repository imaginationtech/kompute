...
// FIXME: Could use a parameterised and/or templated test here to reduce code duplication.
...
TEST(TestImage, LargeVectorSize)
{
    ...
    // It's OK to initilaise an image from a vector which is larger than the image.
