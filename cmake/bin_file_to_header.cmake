...
if(NOT VARIABLE_NAME)
    get_filename_component(VARIABLE_NAME ${INPUT_SHADER_FILE} NAME)
endif()

bin2h(SOURCE_FILE ${INPUT_SHADER_FILE} HEADER_FILE ${OUTPUT_HEADER_FILE} VARIABLE_NAME ${VARIABLE_NAME} HEADER_NAMESPACE ${HEADER_NAMESPACE})
